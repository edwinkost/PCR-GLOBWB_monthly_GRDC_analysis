...
ANALYSIS_OUTPUT_FOLDER="/scratch-shared/edwin/pcrglobwb_wmo_run_validation/wmo_run/validation_1981-2019/"
...
ANALYSIS_OUTPUT_FOLDER="/scratch-shared/edwin/pcrglobwb_wmo_run_validation/benchmark_pgb_aqueduct/validation_1981-2019/"
sbatch -J ${JOB_NAME} --export DISCHARGE_FILENAME=${DISCHARGE_FILENAME},ANALYSIS_OUTPUT_FOLDER=${ANALYSIS_OUTPUT_FOLDER} ${SLURM_SCRIPT}
