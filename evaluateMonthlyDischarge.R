...
#~  layer(data = mergedTable, mapping = aes(x = date, y = simulation  ), geom = "line", colour = "blue", size = 0.35) + # model results
 layer(data = mergedTable, mapping = aes(x = date, y = observation, colour =  "red", size = 0.90), geom = "line" ) + # measurement
 layer(data = mergedTable, mapping = aes(x = date, y = simulation , colour = "blue", size = 0.35), geom = "line" ) + # model results
#
