...
#~  layer(data = mergedTable, mapping = aes(x = date, y = simulation  ), geom = "line", colour = "blue", size = 0.35) + # model results
 layer(data = mergedTable, mapping = aes(x = date, y = observation), geom = "line" , geom_params = list(color =  "red", size = 0.90)) + # measurement
 layer(data = mergedTable, mapping = aes(x = date, y = simulation ), geom = "line" , geom_params = list(color = "blue", size = 0.35)) + # model results
#
