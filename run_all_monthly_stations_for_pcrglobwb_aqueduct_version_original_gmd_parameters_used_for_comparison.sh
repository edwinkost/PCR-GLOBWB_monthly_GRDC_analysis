...
#~ edwinhs@fcn6.bullx:/scratch-shared/edwinhs/pcrglobwb_aqueduct_2021_develop/original_gmd_paper_05min$ ls -lah *
#~ lrwxrwxrwx 1 edwinhs edwinhs 195 May  8 15:34 discharge_monthAvg_output_1958-01-31_to_2015-12-31.zip.nc -> /scratch-shared/edwinvua/pcrglobwb2_output_gmd_paper_rerun_201903XX_05min_using_consistent_pcraster/05min/non-natural/merged_1958_to_2015/discharge_monthAvg_output_1958-01-31_to_2015-12-31.zip.nc

pcrglobwb_output_folder="/scratch-shared/edwinhs/pcrglobwb_aqueduct_2021_develop/original_gmd_paper_05min/"

global_analysis_out_dir=${pcrglobwb_output_folder}"/monthly_discharge_evaluation/"

discharge_file_name="discharge_monthAvg_output_1958-01-31_to_2015-12-31.zip.nc"
