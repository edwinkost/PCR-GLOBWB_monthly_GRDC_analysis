...
folder_of_analysis_summaries = "/scratch/depfg/sutan101/watersis_runs_may_2026/europe_5km_v20260528_DONE/netcdf/reproject_to_0.05arcdeg/analysis_1990-2019/"

folder_of_analysis_summaries = "/scratch/depfg/sutan101/benchmark_for_watersis_runs/aqueduct/analysis_1990-2019/"
...
# lat/lon extent of Europe:
# min lon: 2
# max lon: 24
# min lat: 4
# max lat: 56
performance_table_selected = performance_table_selected[which(performance_table_selected$grdc_longitude_in_arc_degree >  2),]
performance_table_selected = performance_table_selected[which(performance_table_selected$grdc_longitude_in_arc_degree < 24),]
performance_table_selected = performance_table_selected[which(performance_table_selected$grdc_latitude_in_arc_degree  >  4),]
performance_table_selected = performance_table_selected[which(performance_table_selected$grdc_latitude_in_arc_degree  < 56),]
